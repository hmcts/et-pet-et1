...
RSpec.describe 'Refund Validations - Case Details Page', js: true, type: :feature do
  ...
  it 'A user does not fill in any fields in the case details step' do
  ...
  it 'A user does not fill in any fields in the case details step with same address' do
  ...
  it 'A user does not fill in any fields in the case details step with changed address' do
  ...
  it 'A user does not fill in any fields apart from has representative in the case details step with same address' do
    when_i_answer_no_to_the_has_your_address_changed_question_for_refunds
  ...
  it 'A user fills in wrongly formatted ET and ET case numbers in the case details step with same address and no representative' do
    when_i_answer_no_to_the_has_your_address_changed_question_for_refunds
  ...
  it 'A user types too many characters into the additional information field in the case details step with same address and no representative' do
    when_i_answer_no_to_the_has_your_address_changed_question_for_refunds
    and_i_answer_no_to_the_had_representative_question_for_refunds
