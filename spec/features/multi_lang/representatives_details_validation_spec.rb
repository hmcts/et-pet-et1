...
RSpec.describe 'Representatives Details Validation', type: :feature, js: true do
  it 'filters out an incorrect phone number and provides the correct message' do
    ...
    claimant = build(:ui_claimant, :default)
    ...
    representative = build(:ui_representative, :default, phone_or_mobile_number: 'somethingwromg', alternative_phone_or_mobile_number: 'something_wrong')
    ...
    representatives_details_page.assert_error_messages phone_or_mobile_number: 'claimants_details.errors.invalid_phone_number',
