...
RSpec.describe 'Dynatrace script tag', js: false, type: :feature do
  context 'with value specified' do
    ...
    it 'returns the correct script tag' do
      visit root_path
      expect(page).to have_css('script[type="text/javascript"][src="https://js-cdn.dynatrace.com/jstag/17177a07246/123456/7890_complete.js"][crossorigin="anonymous"]', visible: :all)
    end
  end
end
