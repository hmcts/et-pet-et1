...
describe 'Multiple respondents', :js, type: :feature do
  ...
  describe 'adding respondents' do
    ...
    it 'adding more than one additional respondent' do
      extra_ui_respondent = build(:ui_secondary_respondent, :default)
  ...
  describe 'destroying respondents' do
    ...
    it 'deleting arbitrary respondents' do
      additional_respondents_page.load
  ...
  describe 'indicating there are no additional respondents' do
    it 'when no additional respondents have been previously added' do
      additional_respondents_page.load
      additional_respondents_page.
    ...
    it 'when additional respondents have been previously added' do
