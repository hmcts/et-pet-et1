  ...
  module Test
    class EmploymentUi
      attr_accessor :was_employed, :current_situation, :job_title,
                    :start_date, :end_date, :hours_worked_per_week, :gross_pay, :gross_pay_period_type,
                    :net_pay, :net_pay_period_type, :notice_period_end_date, :worked_notice_period,
...
FactoryBot.define do
  factory :ui_employment, class: ::ET1::Test::EmploymentUi do
    ...
    trait :default do
      ...
      gross_pay { 10000 }
      gross_pay_period_type { :'employment.gross_pay_period_type.options.weekly' }
      net_pay { 6000 }
      net_pay_period_type { :'employment.net_pay_period_type.options.weekly' }
    end
  end
end
