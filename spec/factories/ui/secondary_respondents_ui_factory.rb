module ET1
  module Test
    SecondaryRespondentUi = Struct.new('RespondentUi', :name, :address_building, :address_street, :address_town, :address_county, :address_post_code, :acas_number, :has_acas_number, :dont_have_acas_number_reason, keyword_init: true)
  end
end
