...
def then_i_should_only_see_months_in_year_in_all_of_the_fee_dates(months_as_string, year)
...
def then_i_should_see_all_months_in_year_in_all_of_the_fee_dates(year)
...
def then_i_should_see_only_years_in_the_year_dropdown_of_all_of_the_fee_dates(years_as_string)
