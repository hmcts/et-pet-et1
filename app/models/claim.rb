class Claim < ActiveRecord::Base
  ...
  validates :respondents, respondents_count: {
    maximum: Rails.application.config.additional_respondents_limit + 1,
    message: "Number of respondents must not exceed 4" } # TODO use i18n
