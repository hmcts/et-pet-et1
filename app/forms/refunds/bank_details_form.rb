module Refunds
  class BankDetailsForm < Form
    ...
    validates :payment_building_society_account_name, :payment_building_society_name, :payment_building_society_account_number, :payment_building_society_sort_code, presence: true, if: :is_building_society_type?
