module Refunds
  class FeesForm < Form
    ...
    validates :et_issue_fee_payment_date, date: true, if: -> (obj) { obj.et_issue_fee.present? && obj.et_issue_fee > 0 && !obj.et_issue_fee_payment_date_unknown? }
    validates :et_hearing_fee_payment_method, presence: true, if: -> (obj) { obj.et_hearing_fee.present? && obj.et_hearing_fee > 0}
    validates :et_hearing_fee_payment_date, date: true, if: -> (obj) { obj.et_hearing_fee.present? && obj.et_hearing_fee > 0 && !obj.et_hearing_fee_payment_date_unknown? }
    ...
    validates :et_reconsideration_fee_payment_date, date: true, if: -> (obj) { obj.et_reconsideration_fee.present? && obj.et_reconsideration_fee > 0 && !obj.et_reconsideration_fee_payment_date_unknown? }
    validates :eat_issue_fee_payment_method, presence: true, if: -> (obj) { obj.eat_issue_fee.present? && obj.eat_issue_fee > 0 }
    validates :eat_issue_fee_payment_date, date: true, if: -> (obj) { obj.eat_issue_fee.present? && obj.eat_issue_fee > 0 && !obj.eat_issue_fee_payment_date_unknown? }
    validates :eat_hearing_fee_payment_method, presence: true, if: -> (obj) { obj.eat_hearing_fee.present? && obj.eat_hearing_fee > 0}
    validates :eat_hearing_fee_payment_date, date: true, if: -> (obj) { obj.eat_hearing_fee.present? && obj.eat_hearing_fee > 0 && !obj.eat_hearing_fee_payment_date_unknown? }
