var originalCaseDetails = (function() {
    function publishCurrentAddressChanged() {
        val = $('.main-content.refunds_original_case_details [name=\'refunds_original_case_details[address_changed]\']:checked').val();
        $.publish('address_changed', val);
    }
    function publishCurrentHadRepresentative() {
        val = $('.main-content.refunds_original_case_details [name=\'refunds_original_case_details[claim_had_representative]\']:checked').val();
