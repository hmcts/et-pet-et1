...
function enableOtherFieldsWhenAllowed() {
  ...
  privateFields
    .etReconsiderationFeeEl()
    .on("change keyup keypress", updateOtherFields);
...
function updateTotalFeesOnChange() {
  ...
  privateFields
    .etReconsiderationFeeEl()
    .on("change keyup keypress", updateTotalFees);
...
privateFields.etIssueFeePaymentDateUnknownEl = function () {
  return $(
    ".refunds_fees [name='refunds_fees[et_issue_fee_payment_date_unknown]']",
  );
};
...
privateFields.etHearingFeePaymentDateYearEl = function () {
  return $(
    ".refunds_fees [name='refunds_fees[et_hearing_fee_payment_date(1)]']",
  );
};
privateFields.etHearingFeePaymentDateMonthEl = function () {
  return $(
    ".refunds_fees [name='refunds_fees[et_hearing_fee_payment_date(2)]']",
  );
};
privateFields.etHearingFeePaymentDateUnknownEl = function () {
  return $(
    ".refunds_fees [name='refunds_fees[et_hearing_fee_payment_date_unknown]']",
  );
};
privateFields.etHearingFeePaymentMethodEl = function () {
  return $(
    ".refunds_fees [name='refunds_fees[et_hearing_fee_payment_method]']",
  );
};
...
privateFields.etReconsiderationFeePaymentDateYearEl = function () {
  return $(
    ".refunds_fees [name='refunds_fees[et_reconsideration_fee_payment_date(1)]']",
  );
};
privateFields.etReconsiderationFeePaymentDateMonthEl = function () {
  return $(
    ".refunds_fees [name='refunds_fees[et_reconsideration_fee_payment_date(2)]']",
  );
};
privateFields.etReconsiderationFeePaymentDateUnknownEl = function () {
  return $(
    ".refunds_fees [name='refunds_fees[et_reconsideration_fee_payment_date_unknown]']",
  );
};
privateFields.etReconsiderationFeePaymentMethodEl = function () {
  return $(
    ".refunds_fees [name='refunds_fees[et_reconsideration_fee_payment_method]']",
  );
};
...
privateFields.eatIssueFeePaymentDateYearEl = function () {
  return $(
    ".refunds_fees [name='refunds_fees[eat_issue_fee_payment_date(1)]']",
  );
};
privateFields.eatIssueFeePaymentDateMonthEl = function () {
  return $(
    ".refunds_fees [name='refunds_fees[eat_issue_fee_payment_date(2)]']",
  );
};
privateFields.eatIssueFeePaymentDateUnknownEl = function () {
  return $(
    ".refunds_fees [name='refunds_fees[eat_issue_fee_payment_date_unknown]']",
  );
};
...
privateFields.eatHearingFeePaymentDateYearEl = function () {
  return $(
    ".refunds_fees [name='refunds_fees[eat_hearing_fee_payment_date(1)]']",
  );
};
privateFields.eatHearingFeePaymentDateMonthEl = function () {
  return $(
    ".refunds_fees [name='refunds_fees[eat_hearing_fee_payment_date(2)]']",
  );
};
privateFields.eatHearingFeePaymentDateUnknownEl = function () {
  return $(
    ".refunds_fees [name='refunds_fees[eat_hearing_fee_payment_date_unknown]']",
  );
};
privateFields.eatHearingFeePaymentMethodEl = function () {
  return $(
    ".refunds_fees [name='refunds_fees[eat_hearing_fee_payment_method]']",
  );
};
